...
- [Active work branch](arch_active_branch.md) — `followup-dispatch-ui` pushed @ `b0c9b19`; **A52 fix `ebcf4eb` UNPUSHED (push first)**. 2026-06-05 eve: Search COMPLETE 6/6 + acceptance bug auto-fixed; SKILLS v0.2 shipped; Horizon run aborted cleanly at BL-0001 (auth-break capability wall). NEXT: push, then decide Horizon BL-0001 diagnosis
