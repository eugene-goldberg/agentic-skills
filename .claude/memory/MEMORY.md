...
- [Active work branch](arch_active_branch.md) — **branch model: work on `development` → FF into `main`; these are the ONLY live branches.** `followup-dispatch-ui` merged into main + deleted (local+remote) 2026-06-07. Tip @ `78559c3`. This session: scorer scorecard persistence, Janitor role (R16), item #1 gate fix, Kanban stress experiment (crew PASSED)
